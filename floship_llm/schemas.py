...
class ToolParameter(BaseModel):
    ...
    type: str = Field(description="The type of the parameter (e.g., 'string', 'integer', 'boolean', 'array', 'object').")
    description: Optional[str] = Field(default=None, description="Description of what this parameter does.")
    required: bool = Field(default=False, description="Whether this parameter is required.")
    enum: Optional[List[str]] = Field(default=None, description="List of allowed values for this parameter.")
    default: Optional[Any] = Field(default=None, description="Default value for this parameter.")
...
class ToolFunction(BaseModel):
    ...
    parameters: List[ToolParameter] = Field(default=[], description="List of parameters this function accepts.")
    function: Optional[Callable] = Field(default=None, description="The actual Python function to execute.")
...
class ToolResult(BaseModel):
    ...
    content: str = Field(description="String representation of the tool execution result.")

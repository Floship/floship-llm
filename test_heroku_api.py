...
try:
    ...
    response = llm.prompt(
        "Say 'Hello from Heroku Inference API!' and explain in one sentence what you are."
    )
    print(f"\n✓ Response received:\n{response}")
    ...
    llm2 = LLM(temperature=0.7, max_completion_tokens=150, top_k=50)
    ...
    llm2b = LLM(top_p=0.9, max_completion_tokens=150)

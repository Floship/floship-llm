...
class TestSuggestion:
    ...
    def test_suggestion_missing_required_fields(self):
        ...
        errors = exc_info.value.errors()
        required_fields = {'thinking', 'file_path', 'line', 'suggestion', 'severity', 'type', 'reason'}
...
class TestSuggestionsResponse:
    ...
    def test_suggestions_response_invalid_suggestion_item(self):
        ...
        suggestion_errors = [e for e in errors if e['loc'][0] == 'suggestions' and e['loc'][1] == 1]
...
class TestLabels:
    ...
    def test_labels_single_label(self):
        ...
        data = {
            "thinking": "Only one label needed",
            "labels": ["bug"]
        }
    ...
    def test_labels_max_five_labels(self):
        ...
        assert labels.labels == ["bug", "high-priority", "backend", "urgent", "security"]
    ...
    def test_labels_invalid_labels_type(self):
        ...
        data = {
            "thinking": "Test thinking",
            "labels": "not-a-list"  # Should be list
        }
    ...
    def test_labels_non_string_label_items(self):
        ...
        data = {
            "thinking": "Test thinking",
            "labels": ["bug", 123, "priority-high"]  # 123 should cause validation error
        }
